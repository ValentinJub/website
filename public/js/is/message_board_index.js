$(function() {
    ...
    $('#reportThread').submit(function(e){
      var url = "/projects/is/message-board/api/threads/"+$('#board2').val();
      $.ajax({
        type: "PUT",
        url: url,
        data: $(this).serialize(),
    ...
    $('#deleteThread').submit(function(e){
      var url = "/projects/is/message-board/api/threads/"+$('#board3').val();
      $.ajax({
        type: "DELETE",
        url: url,
        data: $(this).serialize(),
    ...
    $('#reportReply').submit(function(e){
      var url = "/projects/is/message-board/api/replies/"+$('#board5').val();
      $.ajax({
        type: "PUT",
        url: url,
        data: $(this).serialize(),
    ...
    $('#deleteReply').submit(function(e){
      var url = "/projects/is/message-board/api/replies/"+$('#board6').val();
      $.ajax({
        type: "DELETE",
        url: url,
        data: $(this).serialize(),
