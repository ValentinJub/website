$(function() {
    ...
    const currentBoard = parts[parts.length - 1];
    var url = "/projects/is/message-board/api/threads/"+currentBoard;
    ...
    $.ajax({
      ...
      success: function(data)
      {
        ...
        data.forEach(function(ele) {
          ...
          thread.push('<form action="/projects/is/message-board/api/replies/'+currentBoard+'" method="post" id="newReply">');
          ...
          thread.push('<input type="text" placeholder="password to delete" name="delete_password" required=""><input class="marginput" type="submit" value="Submit">')
    ...
    $('#newThread').submit(function(){
      $(this).attr('action', "/projects/is/message-board/api/threads/" + currentBoard);
    });
    ...
    $('#boardDisplay').on('submit','#reportReply', function(e) {
      var url = "/projects/is/message-board/api/replies/"+currentBoard;
      $.ajax({
        type: "PUT",
        url: url,
        data: $(this).serialize(),
